...
export class StatsService {
 ...
 // const url = `http://localhost:8080/players/stats?id=${id}`;
    const url = `https://vttpminiproject-02-augustine.up.railway.app/players/stats?id=${id}`;
    console.log('url', url);
 ...
 // const url = `http://localhost:8080/players`;
    const url = `https://vttpminiproject-02-augustine.up.railway.app/players`;
    console.log('url', url);
 ...
 // const url = `http://localhost:8080/players/delete?id=${id}`;
    const url = `https://vttpminiproject-02-augustine.up.railway.app/players/delete?id=${id}`;
    console.log('url', url);
